...
import pageObject.SearchObjects;
...
public class BaseClass
{
	...
	protected SearchObjects searchObject;
	protected IMDBUtilities util;
	protected ReadProperties read=new ReadProperties();
